...
import com.example.assignment2.fragments.AddFragment
    ...
    private fun updateUI(user: FirebaseUser?) {
        ...
        if (user != null) {
            ...
            // app.database = FirebaseDatabase.getInstance().reference
             app.database = FirebaseDatabase.getInstance("https://myassignment2-3005a-default-rtdb.europe-west1.firebasedatabase.app/").reference
